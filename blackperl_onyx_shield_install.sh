...
echo -e "${CYAN}║      ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝╚══════╝╚═════╝ ║${NC}"
echo -e "${BLUE}║                                                                            ║${NC}"
echo -e "${BLUE}║                          ${CYAN}O N Y X S H I E L D${BLUE}                 ║${NC}"
echo -e "${BLUE}║                                                                            ║${NC}"
echo -e "${BLUE}╚════════════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${BLUE}║                                                                            ║${NC}"
...
echo -e "${CYAN}  / _ \\  _ __  _  _| |__     / ___|| |__ (_)___| |__  | |${NC}"
echo -e "${CYAN} | | | || '_ \\| |/ / '_ \\____\\___ \\| '_ \\| / __| '_ \\ | |${NC}"
echo -e "${CYAN} | |_| || | | |   <| |_) |_____|__) | | | | \\__ \\ | | ||_|${NC}"
echo -e "${CYAN}  \\___/ |_| |_|_|\\_\\_.__/     |____/|_| |_|_|___/_| |_(_)$NC"
