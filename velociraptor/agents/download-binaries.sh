#!/bin/bash
# BlackPerl_Onyx_Shield - Download Velociraptor Agent Binaries
...
if [ -n "$SUDO_USER" ] && [ "$SUDO_USER" != "root" ]; then
    ...
    # Get the owner of the parent BlackPerl_Onyx_Shield directory
    onyxshield_DIR="$(dirname "$(dirname "$SCRIPT_DIR")")"
